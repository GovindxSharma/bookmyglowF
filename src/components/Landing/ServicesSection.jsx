...
const ServicesSection = () => {
  return (
    <section
      id="services"
      className="py-24 px-6 bg-gradient-to-b from-[#F5F6FF] to-[#EDEFFF]"
    >
        ...
        {services.map((service) => (
          ...
          >
            ...
            <div className="absolute bottom-0 w-full p-6 text-center text-white">
              ...
              <p className="mt-2 text-sm sm:text-base drop-shadow-md">
                {service.description}
              </p>
            </div>
          </motion.div>
            ...
            <SwiperSlide key={service.id}>
              ...
              >
                ...
                <div className="absolute bottom-0 w-full p-4 text-center text-white">
                  ...
                  <p className="mt-1 text-xs sm:text-sm drop-shadow-md">
                    {service.description}
                  </p>
                </div>
              </motion.div>
